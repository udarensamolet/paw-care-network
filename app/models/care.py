...
class CareRequest(db.Model):
    ...
    pet_id = db.Column(db.Integer, db.ForeignKey("pets.id", ondelete="SET NULL"),
    ...
    status = db.Column(db.String(20), nullable=False, default="open")  # open, matched, confirmed, cancelled, completed
